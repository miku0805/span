...
admins = ["dhVlDdUpXK@163.com", "HF6qcXRHu4@163.com"]

passwds = ["F2wxoUYR5y", "wIQHcZ5qeL"]
...
for admin, passwd in zip(admins, passwds):
    ...
    # time.sleep(2)
    # p_btn = driver.find_element(By.ID, 'id_l')
    # p_btn.click()
    ...
    time.sleep(8)
    p_btn = driver.find_element(By.ID, 'home.cards.card.rewards.cold')
    p_btn.click()
